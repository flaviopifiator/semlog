...
READMES = {
    "en": {
        ...
        "recipes": "Framework recipes",
        "configuration": "Configuration",
        "documentation": "Documentation",
        "performance": "Performance",
        "modes": "Modes",
        "configuration_sources": "Configuration sources",
        "root_level": "The root logger level in hybrid mode",
    ...
    "es": {
        ...
        "recipes": "Recetas para frameworks",
        "configuration": "Configuración",
        "documentation": "Documentación",
        "performance": "Rendimiento",
        "modes": "Modos",
        "configuration_sources": "Fuentes de configuración",
        "root_level": "El nivel del logger raíz en modo hybrid",
